...
- Name: family-card-validation.spec.ts >> POST /api/orders — familyCards validation >> rejects familyCards with multiple invalid entries and reports all issues
- Location: tests/family-card-validation.spec.ts:139:3
