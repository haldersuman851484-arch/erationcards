...
- Name: family-card-validation.spec.ts >> POST /api/orders — familyCards validation >> accepts a valid order with no family cards (quantity 1)
- Location: tests/family-card-validation.spec.ts:35:3
