...
- Name: payment-confirm.spec.ts >> Payment confirmation >> Confirm button disappears after confirming payment and shows confirmed badge
- Location: tests/payment-confirm.spec.ts:124:3
...
Locator: getByTestId('button-confirm-payment-42')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('button-confirm-payment-42')
...
```ts
  ...
  36  |     amount: "149",
  37  |     status: "pending",
  38  |     paymentStatus: "pending",
  39  |     paymentMethod: "upi",
  40  |     paymentScreenshotUrl: "https://example.com/screenshot.jpg",
  41  |     operatorId: null,
  42  |     trackingNumber: null,
  43  |     courierName: null,
  44  |     notes: null,
  45  |     createdAt: "2024-07-10T08:00:00.000Z",
  46  |     updatedAt: "2024-07-10T08:00:00.000Z",
  47  |     ...overrides,
  48  |   };
  49  | }
  50  | 
  51  | type OrderShape = ReturnType<typeof makeOrder>;
  52  | 
