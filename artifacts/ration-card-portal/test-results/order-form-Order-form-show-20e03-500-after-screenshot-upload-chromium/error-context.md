...
- Name: order-form.spec.ts >> Order form >> shows an error and stays on step 3 when the order API returns 500 after screenshot upload
- Location: tests/order-form.spec.ts:194:3
