...
- Name: family-card-validation.spec.ts >> POST /api/orders — familyCards validation >> rejects order when top-level cardType is not in the allowed list
- Location: tests/family-card-validation.spec.ts:168:3
