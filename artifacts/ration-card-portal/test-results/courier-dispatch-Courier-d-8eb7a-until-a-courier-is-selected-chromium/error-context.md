...
- Name: courier-dispatch.spec.ts >> Courier dispatch form >> Confirm Dispatch button is disabled until a courier is selected
- Location: tests/courier-dispatch.spec.ts:141:3
