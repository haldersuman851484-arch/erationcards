...
- Name: courier-dispatch.spec.ts >> Courier dispatch form >> Cancel button hides the dispatch form without updating the order
- Location: tests/courier-dispatch.spec.ts:196:3
