...
- Name: family-card-validation.spec.ts >> POST /api/orders — familyCards validation >> rejects familyCards entry with an invalid cardType
- Location: tests/family-card-validation.spec.ts:117:3
