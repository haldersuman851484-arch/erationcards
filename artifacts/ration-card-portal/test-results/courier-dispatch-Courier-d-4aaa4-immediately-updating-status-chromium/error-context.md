...
- Name: courier-dispatch.spec.ts >> Courier dispatch form >> selecting 'Dispatched' shows the courier form instead of immediately updating status
- Location: tests/courier-dispatch.spec.ts:122:3
...
```ts
  27  |     address: "12 Lake Road",
  28  |     postOffice: "Ballygunge",
  ...
  36  |     amount: "149",
  37  |     status: "printed",
  38  |     paymentStatus: "confirmed",
  39  |     paymentMethod: "upi",
  40  |     paymentScreenshotUrl: null,
  41  |     operatorId: null,
  42  |     trackingNumber: null,
  43  |     courierName: null,
  44  |     notes: null,
  45  |     createdAt: "2024-07-15T09:00:00.000Z",
  46  |     updatedAt: "2024-07-15T09:00:00.000Z",
  47  |     ...overrides,
  48  |   };
  49  | }
  50  | 
  ...
  60  |     onStatusUpdate?: (id: number, body: Record<string, unknown>) => void;
  61  |   }
  62  | ) {
