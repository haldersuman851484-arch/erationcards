...
- Name: family-card-validation.spec.ts >> POST /api/orders — familyCards validation >> accepts a valid order with one well-formed family card
- Location: tests/family-card-validation.spec.ts:50:3
