...
- Name: track-order-mobile.spec.ts >> Track Order page — estimated delivery banner >> banner is absent for pending orders
- Location: tests/track-order-mobile.spec.ts:161:3
