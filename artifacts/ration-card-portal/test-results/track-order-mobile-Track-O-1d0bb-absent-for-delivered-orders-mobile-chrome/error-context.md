...
- Name: track-order-mobile.spec.ts >> Track Order page — estimated delivery banner >> banner is absent for delivered orders
- Location: tests/track-order-mobile.spec.ts:175:3
