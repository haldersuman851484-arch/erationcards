...
- Name: track-order-mobile.spec.ts >> Track Order page — courier tracking link >> shows 'Track with India Post' link for a recognised India Post tracking number on a dispatched order
- Location: tests/track-order-mobile.spec.ts:191:3
