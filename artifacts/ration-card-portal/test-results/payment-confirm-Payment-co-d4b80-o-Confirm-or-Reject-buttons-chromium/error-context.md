...
- Name: payment-confirm.spec.ts >> Payment confirmation >> already-confirmed order shows no Confirm or Reject buttons
- Location: tests/payment-confirm.spec.ts:163:3
...
Locator: locator('text=PVCPAY001')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=PVCPAY001')
