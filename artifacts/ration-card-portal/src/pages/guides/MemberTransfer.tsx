        ...
        <div className="text-center">
          <Button asChild className="bg-primary hover:bg-primary/90">
            <a
              ...
              data-testid="link-official-member-transfer"
            >
              Open the official transfer page
              <ExternalLink className="w-4 h-4 ml-1.5" />
            </a>
          </Button>
          <p className="text-xs text-slate-500 mt-2">
            wbpds.wb.gov.in — Government of West Bengal's official site; the member transfer there is free.{" "}
            <span lang="bn">সরকারি ওয়েবসাইট — সদস্য সরানো ফ্রি।</span>
          </p>
        </div>
      }
      related={[
